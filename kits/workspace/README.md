...
Workspace `{{workspace_name}}` is the shared entry point into this project for every role. Agents read `AGENTS.md`; this file is for people who work without an agent.
